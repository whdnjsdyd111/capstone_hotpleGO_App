        ...
        searchPwbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    PostRun pr = new PostRun("userJoin", MainActivitySearch.this, PostRun.DATA);
                    ...
                    pr.addData("uCode", searchId.getText().toString())
                            .addData("birthpw", searchBirthPw.getText().toString())
                            .addData("nick",searchNamePw.getText().toString());
                    pr.start();
                } catch (Exception e) {
                    e.printStackTrace();
                }
