...
public class Order_details_New extends Fragment {
    ...
    private void initDataset() { // 더미 데이터
        ...
        items.add(new Order_details_New_Data(R.drawable.lank_f, "육회비빔밥 외 1개", "27000원"));
        items.add(new Order_details_New_Data(R.drawable.lank_s, "육회비빔밥 외 1개", "27000원"));
        items.add(new Order_details_New_Data(R.drawable.lank_s, "육회비빔밥 외 1개", "27000원"));
        items.add(new Order_details_New_Data(R.drawable.lank_t, "육회비빔밥 외 1개", "27000원"));
        items.add(new Order_details_New_Data(R.drawable.lank_t, "육회비빔밥 외 1개", "27000원"));
        items.add(new Order_details_New_Data(R.drawable.lank_t, "육회비빔밥 외 1개", "27000원"));
    }
}